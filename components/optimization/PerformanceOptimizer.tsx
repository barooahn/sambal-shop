...
export const criticalImages = [
	"/images/Spice Island Indonesia Sambal Oelek 185g Label.png", // Hero image
	"/images/Spice Island Indonesia Complete Packaging System Mockup.png", // Product showcase
];
