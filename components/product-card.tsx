      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <p className="font-semibold text-sm text-gray-900">Medium-Hot</p>
              <p className="text-xs text-gray-600">🌶️🌶️🌶️</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              <p className="font-semibold text-sm text-gray-900">All Natural</p>
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              <p className="font-semibold text-sm text-gray-900">Premium</p>
          ...
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center">
              <span className="text-orange-600 font-bold text-xs">200g</span>
            </div>
            <div>
              <p className="font-semibold text-sm text-gray-900">Size</p>
              <p className="text-xs text-gray-600">Perfect portion</p>
            </div>
          </div>
        </div>
