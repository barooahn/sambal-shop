...
export default function RecipeCard({ recipe, showFullRecipe = false }: RecipeCardProps) {
	...
	return (
		<>
			...
			<Card className="overflow-hidden shadow-lg border border-gold-200 bg-gradient-to-br from-cream-50 to-cream-100 rounded-2xl">
				{/* Recipe Image */}
				...
				<CardHeader className="pb-4">
					...
					<p className="text-gray-600 font-body">{recipe.description}</p>
				</CardHeader>
						...
						<>
							...
							<div>
								...
								<ul className="space-y-2">
									{recipe.ingredients.map((ingredient, index) => (
										<li key={index} className="flex items-start gap-2 text-gray-700 font-body">
							...
							<div className="bg-gold-50 border border-gold-200 rounded-lg p-4">
								...
								<p className="text-sm text-gray-700 font-body">
									For best results, use authentic Indonesian sambal from Spice Island Indonesia. 
									The quality of your sambal will significantly impact the final flavor of this dish.
								</p>
							</div>
						</>
					)}
