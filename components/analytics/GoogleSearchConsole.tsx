...
export const getVerificationInstructions = () => {
  return {
    metaTag: {
      ...
      description: "Add the NEXT_PUBLIC_GSC_VERIFICATION_CODE environment variable with your verification code",
      steps: [
        "Go to Google Search Console (https://search.google.com/search-console)",
        "Add your property (https://sambal-shop.vercel.app)",
    ...
    analytics: {
      ...
      description: "Verify using existing Google Analytics (recommended)",
      steps: [
