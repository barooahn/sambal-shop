	...
	"inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 transform hover:-translate-y-0.5 active:translate-y-0 relative overflow-hidden",
	{
		variants: {
			variant: {
				...
				secondary: "bg-cream-100 text-burgundy-900 hover:bg-burgundy-100 hover:text-burgundy-800 shadow-lg hover:shadow-xl border border-burgundy-200 focus-visible:ring-burgundy-300",
				outline: "border-2 border-burgundy-300 text-burgundy-800 bg-transparent hover:bg-burgundy-700 hover:text-cream-50 hover:border-burgundy-700 shadow-md hover:shadow-lg focus-visible:ring-burgundy-500",
				...
				heritage: "bg-cream-100 text-burgundy-900 border-2 border-burgundy-200 hover:bg-burgundy-100 hover:text-burgundy-800 hover:border-burgundy-300 shadow-md hover:shadow-lg focus-visible:ring-burgundy-300",
