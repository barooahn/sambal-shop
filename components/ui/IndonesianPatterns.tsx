...
interface IndonesianPatternProps {
  variant?: 'batik-subtle' | 'batik-traditional' | 'spice-weave' | 'palm-leaf' | 'coconut-fiber';
...
export default function IndonesianPattern({ 
  ...
  return (
    <div 
      className={`absolute inset-0 pointer-events-none ${pattern.className} ${colorClass} ${opacityClass} ${className}`}
      aria-hidden="true"
      role="presentation"
    />
  );
...
export function BatikBackground({ 
  ...
  return (
    <div className={`relative ${className}`}>
      <IndonesianPattern variant="batik-subtle" opacity="light" color="turmeric" />
      {children}
    </div>
  );
}
...
export function SpiceMarketBackground({ 
  ...
  return (
    <div className={`relative bg-gradient-to-br from-coconut-50 via-turmeric-50 to-chili-50 ${className}`}>
      <IndonesianPattern variant="spice-weave" opacity="light" color="chili" />
...
export function TraditionalBackground({ 
  ...
  return (
    <div className={`relative bg-gradient-to-r from-coconut-50 to-coconut-100 ${className}`}>
      <IndonesianPattern variant="batik-traditional" opacity="medium" color="burgundy" />
      <div className="relative z-10">
        {children}
      </div>
    </div>
...
export function CulturalDivider({ 
  ...
  return (
    <div className={`relative h-24 flex items-center justify-center bg-gradient-to-r from-turmeric-50 via-chili-50 to-turmeric-50 ${className}`}>
      <IndonesianPattern variant="batik-subtle" opacity="light" color="chili" />
