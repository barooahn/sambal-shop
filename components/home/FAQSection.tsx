								...
								{openItems.includes(index) && (
									<div className='px-6 pb-6'>
										<div className='pt-4 border-t border-gold-200'>
											<div 
												className='text-neutral-700 leading-relaxed font-body'
