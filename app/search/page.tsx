					...
					<div className="flex-1">
						...
						{!query && (
							<Card className="p-12 text-center">
								...
								<p className="text-gray-600 mb-6">
									Find products, recipes, articles, and more
								</p>
								...
								<div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-2xl mx-auto">
									<div className="text-center">
										...
										<p className="text-sm text-gray-600">Authentic sambal varieties</p>
									</div>
									<div className="text-center">
										<div className="w-16 h-16 bg-gold-100 rounded-lg flex items-center justify-center mx-auto mb-3">
											👨‍🍳
										</div>
										<h4 className="font-medium text-gray-900 mb-1">Recipes</h4>
										<p className="text-sm text-gray-600">Indonesian dishes</p>
									</div>
									<div className="text-center">
										<div className="w-16 h-16 bg-green-100 rounded-lg flex items-center justify-center mx-auto mb-3">
											📖
										</div>
										<h4 className="font-medium text-gray-900 mb-1">Articles</h4>
										<p className="text-sm text-gray-600">Cooking guides</p>
									</div>
									<div className="text-center">
										...
										<p className="text-sm text-gray-600">Local areas</p>
									</div>
								</div>
							</Card>
						)}
