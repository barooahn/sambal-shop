...
import { Building2, Users, Truck, Award, Phone, Mail, MapPin } from "lucide-react";
	...
	const benefits = [
		{
			...
			description: "Attractive margins for retailers, restaurants, and distributors"
		},
		{
			icon: Users,
			...
			<section className="py-24 bg-gradient-to-br from-burgundy-900 to-burgundy-800 text-white relative overflow-hidden">
				...
				<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-xl sm:text-2xl text-gold-200 max-w-3xl mx-auto font-body">
						Join our growing network of retailers, restaurants, and distributors bringing authentic Indonesian flavors to customers across the UK
					</p>
				</div>
			</section>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-neutral-600 max-w-3xl mx-auto font-body">
							We're committed to supporting our wholesale partners with premium products and exceptional service
						</p>
					</div>

					<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
						{benefits.map((benefit, index) => (
							<div key={index} className="text-center bg-cream-50 rounded-3xl p-8 border border-gold-200">
					...
					<div className="grid lg:grid-cols-2 gap-16">
						<div>
							...
							<p className="text-lg text-neutral-700 mb-8 font-body">
								Ready to bring authentic Indonesian sambal to your customers? 
							...
							<div className="space-y-6">
								<div className="flex items-center space-x-4">
									...
									<div>
										<h4 className="font-bold text-burgundy-900 font-brand">Phone</h4>
										<p className="text-neutral-600 font-body">+44 (0) 20 1234 5678</p>
									</div>
								</div>
								<div className="flex items-center space-x-4">
									...
									<div>
										<h4 className="font-bold text-burgundy-900 font-brand">Email</h4>
										<p className="text-neutral-600 font-body">wholesale@spiceislandindonesia.co.uk</p>
									</div>
								</div>
								<div className="flex items-center space-x-4">
									...
									<div>
										<h4 className="font-bold text-burgundy-900 font-brand">Address</h4>
										<p className="text-neutral-600 font-body">London, United Kingdom</p>
									</div>
								</div>
							</div>
						</div>

						<div className="bg-white rounded-3xl p-8 shadow-luxury border border-gold-200">
							...
							{isSubmitted ? (
								<div className="text-center py-8">
									...
									<p className="text-green-600 font-body">
										We've received your wholesale enquiry and will get back to you within 24 hours.
									</p>
								</div>
							) : (
