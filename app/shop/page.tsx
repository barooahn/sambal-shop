...
export const metadata = {
	...
	alternates: {
		canonical: "https://www.spiceislandindonesia.com/shop",
	},
};
				...
				<section className='py-16 sm:py-20 bg-gradient-to-br from-burgundy-900 via-burgundy-800 to-gold-900 text-white relative overflow-hidden'>
					...
					<div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
						...
						<p className='text-xl sm:text-2xl text-gold-200 mb-8 max-w-4xl mx-auto leading-relaxed font-body'>
							Three distinctive sambal varieties made by
							Chef Yossie using traditional family recipes.
							From pure fire to aromatic sophistication.
						</p>
						...
						{SALES_ENABLED ? (
							...
							<Badge className='bg-burgundy-600 text-white text-lg px-8 py-4 mb-12'>
								🔔 Coming Soon - Join the UK VIP List
								for Launch Updates
							</Badge>
						)}
					</div>
					...
					<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
						<div className='text-center mb-16'>
							...
							<p className='text-xl text-neutral-600 max-w-3xl mx-auto font-body leading-relaxed'>
								...
								experience - choose your perfect heat
							...
							{enhancedProducts.map((product) => {
								...
								return (
									...
									>
										...
										>
											<div
												className={`aspect-square flex items-center justify-center relative overflow-hidden rounded-sm`}
											>
												<Image
													src={
														product.image
					...
					<section className='py-24 bg-gradient-to-r from-burgundy-900 to-burgundy-800 text-white'>
						<div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
							...
							<p className='text-xl text-gold-200 mb-8 font-body'>
								...
								discovered the difference authentic
								sambal makes. Each product page has
								detailed information, cooking guides,
