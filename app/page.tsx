...
export default function Home() {
	...
	const handleContactSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			if (result.success) {
				setContactForm({ name: "", email: "", message: "" }); // Clear form on success
			}
			...
			<section className='relative min-h-screen flex items-center justify-center overflow-hidden'>
				...
				<div className='relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
					...
					<p className='text-xl sm:text-2xl text-gray-700 mb-12 max-w-3xl mx-auto leading-relaxed'>
						Bringing the bold, traditional flavors of the
						original Spice Islands directly to British
						kitchens. Experience the authentic taste of
						Indonesia with our premium, handcrafted sambal.
					</p>
					...
					<div className='bg-white/90 backdrop-blur-sm rounded-2xl p-8 max-w-md mx-auto shadow-xl border border-amber-200'>
						...
						<p className='text-gray-600 mb-6'>
							Be the first to know when we launch and
							receive a 10% early bird discount!
						</p>
							...
							newsletterState.message && (
								<p
									className={`mt-4 font-medium ${
										newsletterState.message.includes(
											"already"
										) ||
										newsletterState.message.includes(
											"wrong"
				...
				<div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
					<div className='text-center mb-16'>
						...
						<p className='text-xl text-gray-600 max-w-3xl mx-auto'>
							Our flagship product brings together
							centuries of Indonesian culinary tradition in
							every jar
						</p>
					</div>
						...
						<div className='space-y-6'>
							<div>
								...
								<p className='text-xl text-gray-700 leading-relaxed mb-6'>
									A fiery Indonesian chili sauce
									elevated with aromatic shallots and
									garlic. This bold, garlicky
									condiment is perfect for BBQs,
									stir-fries, and adding authentic
									Indonesian heat to any dish.
								</p>
							</div>
							...
							<div className='bg-amber-50 border border-amber-200 rounded-xl p-6'>
								<h4 className='font-semibold text-gray-900 mb-2'>
									Perfect for UK palates
								</h4>
								<p className='text-gray-700'>
									The bold, garlicky flavor profile
									that British food lovers crave,
									with the authentic Indonesian heat
									and complexity that sets it apart
									from ordinary chili sauces.
								</p>
							</div>
						</div>
					</div>
						...
						<div>
							...
							<div className='space-y-6 text-lg text-gray-700 leading-relaxed'>
								...
								<p>
									...
									bold, complex flavors. Each jar of
									our sambal is handcrafted using
									traditional methods, ensuring every
									spoonful delivers the genuine taste
									of Indonesia.
								</p>
