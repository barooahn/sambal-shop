	...
	const recipes = [
		{
			...
			description: "Transform leftover rice into a spicy, flavorful meal with our authentic sambal",
			time: "15 mins",
			serves: "4",
			difficulty: "Easy",
		...
		},
		{
			...
			description: "Juicy chicken thighs with a sticky, spicy sambal glaze",
			time: "45 mins",
			serves: "4",
			difficulty: "Medium",
		...
		},
		{
			...
			description: "Quick and satisfying noodles with vegetables and our signature sambal",
			time: "20 mins",
			serves: "2",
			difficulty: "Easy",
			...
			<section className="py-24 bg-gradient-to-br from-burgundy-900 to-burgundy-800 text-white relative overflow-hidden">
				...
				<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-xl sm:text-2xl text-gold-200 max-w-3xl mx-auto font-body">
						Discover delicious ways to use our authentic Indonesian sambal in your everyday cooking
					</p>
				</div>
			</section>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-neutral-600 max-w-3xl mx-auto font-body">
							From quick weeknight dinners to impressive weekend feasts, our sambal adds authentic Indonesian flavor to any dish
						</p>
					</div>

					<div className="grid lg:grid-cols-3 gap-8">
						{recipes.map((recipe) => (
							<div key={recipe.id} className="bg-white rounded-3xl shadow-lg overflow-hidden border border-gold-200 hover:shadow-luxury transition-all duration-300">
						...
						<div>
							...
							<div className="space-y-6 text-lg text-neutral-700 leading-relaxed font-body">
								<div className="bg-cream-50 rounded-2xl p-6 border border-gold-200">
									<h3 className="font-bold text-burgundy-900 mb-2 font-brand">Start Small</h3>
									<p>Sambal is potent! Start with a small amount and add more to taste. You can always add more heat, but you can't take it away.</p>
								</div>
								<div className="bg-cream-50 rounded-2xl p-6 border border-gold-200">
									<h3 className="font-bold text-burgundy-900 mb-2 font-brand">Perfect Pairings</h3>
									<p>Sambal pairs beautifully with coconut milk, lime juice, and fresh herbs. Try it with grilled meats, stir-fries, and rice dishes.</p>
								</div>
								<div className="bg-cream-50 rounded-2xl p-6 border border-gold-200">
									<h3 className="font-bold text-burgundy-900 mb-2 font-brand">Storage Tips</h3>
									<p>Keep opened jars refrigerated and use a clean spoon each time. Our sambal will keep its flavor for months when stored properly.</p>
								</div>
							</div>
						</div>
			...
			<section className="py-24 bg-gradient-to-r from-burgundy-900 to-burgundy-800 text-white">
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-xl text-gold-200 mb-8 font-body">
						Get our authentic sambal and start creating delicious Indonesian-inspired meals tonight
					</p>
