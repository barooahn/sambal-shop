...
export default function ShippingPage() {
	...
	const deliveryAreas = [
		...
		{ region: "Northern Ireland", time: "5-7 business days", available: true },
		{ region: "Channel Islands", time: "7-10 business days", available: false },
		{ region: "Isle of Man", time: "7-10 business days", available: false }
	];
			...
			<section className="py-24 bg-gradient-to-br from-burgundy-900 to-burgundy-800 text-white relative overflow-hidden">
				...
				<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-xl sm:text-2xl text-gold-200 max-w-3xl mx-auto font-body">
						Fast, reliable delivery of authentic Indonesian sambal straight to your door
					</p>
				</div>
			</section>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid md:grid-cols-3 gap-8">
						{shippingOptions.map((option, index) => (
							<div key={index} className="bg-cream-50 rounded-3xl p-8 border border-gold-200 text-center">
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						...
						<div>
							...
							<div className="space-y-6 text-lg text-neutral-700 leading-relaxed font-body">
								<p>
									Every order is carefully packed in our signature shipping boxes, 
									designed to protect your sambal during transit and create a 
									delightful unboxing experience.
								</p>
								<p>
									Our packaging is eco-friendly and recyclable, reflecting our 
									commitment to sustainability while ensuring your products 
							...
							<div className="grid grid-cols-2 gap-6 mt-8">
								<div className="flex items-center space-x-3">
									...
									<div>
										<h4 className="font-bold text-burgundy-900 font-brand">Protected</h4>
										<p className="text-sm text-neutral-600 font-body">Secure packaging</p>
									</div>
								</div>
								<div className="flex items-center space-x-3">
									...
									<div>
										<h4 className="font-bold text-burgundy-900 font-brand">Eco-Friendly</h4>
										<p className="text-sm text-neutral-600 font-body">Recyclable materials</p>
									</div>
								</div>
							</div>
						</div>
						...
						<div className="bg-cream-50 rounded-3xl p-8 border border-gold-200">
							<div className="grid md:grid-cols-2 gap-6">
								{deliveryAreas.map((area, index) => (
									<div key={index} className="flex items-center justify-between p-4 bg-white rounded-2xl border border-gold-200">
										<div className="flex items-center space-x-3">
											<MapPin className={`w-5 h-5 ${area.available ? 'text-green-600' : 'text-neutral-400'}`} />
											<div>
												<h4 className="font-bold text-burgundy-900 font-brand">
													{area.region}
												</h4>
												<p className="text-sm text-neutral-600 font-body">
													{area.available ? area.time : 'Coming Soon'}
												</p>
											</div>
										</div>
					...
					<div className="space-y-6">
						<div className="bg-white rounded-3xl p-8 border border-gold-200">
							...
							<p className="text-neutral-700 font-body">
								Orders placed before 2 PM Monday-Friday are typically dispatched the same day. 
								Weekend orders are dispatched on the next business day.
							</p>
						</div>
						...
						<div className="bg-white rounded-3xl p-8 border border-gold-200">
							...
							<p className="text-neutral-700 font-body">
								Yes! You'll receive a tracking number via email once your order is dispatched. 
								You can track your package through our delivery partner's website.
							</p>
						</div>
						...
						<div className="bg-white rounded-3xl p-8 border border-gold-200">
							...
							<p className="text-neutral-700 font-body">
								Our delivery partners will leave a card with instructions for redelivery or 
								collection from a local depot. Some areas offer safe place delivery options.
							</p>
						</div>
						...
						<div className="bg-white rounded-3xl p-8 border border-gold-200">
							...
							<p className="text-neutral-700 font-body">
								No hidden fees! The shipping cost shown at checkout is the total delivery charge. 
								There are no additional handling fees or surcharges.
							</p>
						</div>
					</div>
				</div>
