...
export const metadata = {
	...
	openGraph: {
		...
		images: [
			{
				url: "https://spiceislandindonesia.com/images/Spice Island Indonesia Sambal Bali 185g Label.webp",
				width: 400,
				height: 400,
...
export default function SambalBaliAromaticSpicyPage() {
	...
	const faqData = [
		...
		{
			question: "What are the key ingredients in authentic sambal bali?",
	...
	const productData = {
		...
		additionalProperties: {
			...
			ingredients: ["Red Chilies", "Galangal", "Lemongrass", "Kaffir Lime Leaves", "Shallots", "Garlic", "Candlenuts", "Palm Sugar", "Tamarind", "Salt"],
			dietaryInfo: ["Gluten-Free", "Vegan", "No Artificial Preservatives", "Traditional Recipe"],
			origin: "Bali, Indonesia",
			aromaticProfile: "Citrus, Floral, Warm Spices",
			shelfLife: "2 years unopened, 8 weeks refrigerated after opening",
		},
	};
	...
	return (
		<div className='min-h-screen bg-gradient-to-br from-cream-50 to-cream-100'>
			...
			{/* Hero Section */}
			<section className='py-16 sm:py-24 bg-gradient-to-br from-slate-900 via-gray-900 to-green-950 text-white relative overflow-hidden'>
				<div className='absolute top-0 left-0 w-96 h-96 bg-slate-800/20 rounded-full -translate-x-48 -translate-y-48 blur-3xl'></div>
				<div className='absolute bottom-0 right-0 w-96 h-96 bg-green-900/20 rounded-full translate-x-48 translate-y-48 blur-3xl'></div>
						...
						<div className='text-center lg:text-left'>
							...
							<div className='space-y-6 mb-8 max-w-2xl mx-auto lg:mx-0'>
								<p className='text-xl sm:text-2xl text-white leading-relaxed font-body'>
									Discover the <strong className='text-slate-100'>sophisticated aromatics</strong> of authentic sambal Bali - where galangal, lemongrass, and kaffir lime create complex layers of flavor.
								</p>
								
								<p className='text-lg text-slate-300 leading-relaxed font-body'>
									Made with <em>real Balinese spices and traditional techniques</em> by Chef Yossie. This isn&apos;t just heat - it&apos;s culinary sophistication in every spoonful.
								</p>
							</div>
				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<div className='text-center mb-16'>
						<h2 className='text-4xl sm:text-5xl font-bold text-green-900 mb-6 font-brand'>
							The Art of
							<span className='text-teal-700 block'>Balinese Aromatics</span>
						</h2>
						<p className='text-xl text-neutral-600 max-w-3xl mx-auto font-body leading-relaxed'>
							Each spice in our sambal Bali serves a purpose, creating layers of complexity that transform every dish into a sophisticated culinary experience.
						</p>
					</div>
					...
					<div className='grid lg:grid-cols-3 gap-12'>
						...
						<div className='bg-teal-50 rounded-sm p-8 border border-teal-200'>
							...
							<div className='space-y-6 font-body'>
								<div>
									<h4 className='font-semibold text-green-800 mb-3'>Core Aromatic Blend:</h4>
									<div className='space-y-3'>
										<div className='flex items-start space-x-3'>
											<span className='bg-slate-700 text-white rounded-full w-6 h-6 flex items-center justify-center font-bold text-xs mt-0.5'>G</span>
											<div>
												<p className='font-semibold text-green-800'>Galangal (20%)</p>
												<p className='text-xs text-neutral-600'>Warm, citrusy Indonesian ginger - creates depth</p>
											</div>
										</div>
										<div className='flex items-start space-x-3'>
											<span className='bg-slate-700 text-white rounded-full w-6 h-6 flex items-center justify-center font-bold text-xs mt-0.5'>L</span>
											<div>
												<p className='font-semibold text-green-800'>Lemongrass (15%)</p>
												<p className='text-xs text-neutral-600'>Fresh citrus fragrance - brightens complexity</p>
											</div>
										</div>
										<div className='flex items-start space-x-3'>
											<span className='bg-slate-700 text-white rounded-full w-6 h-6 flex items-center justify-center font-bold text-xs mt-0.5'>K</span>
											<div>
												<p className='font-semibold text-green-800'>Kaffir Lime Leaves (10%)</p>
												<p className='text-xs text-neutral-600'>Floral citrus notes - signature Balinese touch</p>
											</div>
										</div>
										<div className='flex items-start space-x-3'>
											<span className='bg-slate-700 text-white rounded-full w-6 h-6 flex items-center justify-center font-bold text-xs mt-0.5'>C</span>
											<div>
												<p className='font-semibold text-green-800'>Red Chilies (40%)</p>
												<p className='text-xs text-neutral-600'>Medium heat foundation - perfectly balanced</p>
											</div>
										</div>
									</div>
								</div>
								<div className='border-t border-slate-600 pt-4'>
									<h4 className='font-semibold text-green-800 mb-2'>Aromatic Profile:</h4>
									<div className='space-y-2 text-sm'>
										<div className='flex justify-between items-center'>
											<span>Citrus Notes:</span>
											<div className='w-20 h-2 bg-teal-200 rounded-full'><div className='w-16 h-2 bg-slate-700 rounded-full'></div></div>
										</div>
										<div className='flex justify-between items-center'>
											<span>Floral Complexity:</span>
											<div className='w-20 h-2 bg-teal-200 rounded-full'><div className='w-14 h-2 bg-slate-700 rounded-full'></div></div>
										</div>
										<div className='flex justify-between items-center'>
											<span>Warm Spices:</span>
											<div className='w-20 h-2 bg-teal-200 rounded-full'><div className='w-18 h-2 bg-teal-700 rounded-full'></div></div>
										</div>
									</div>
								</div>
							</div>
							...
							<div className='space-y-6 font-body'>
								<div>
									<div className='flex justify-between items-center mb-3'>
										<span className='font-semibold text-green-800'>Scoville Rating</span>
										<span className='text-2xl font-bold text-green-900'>14,000</span>
									</div>
									<div className='w-full bg-cream-200 rounded-full h-3 mb-2'>
										<div className='bg-gradient-to-r from-emerald-600 to-emerald-800 h-3 rounded-full' style={{width: '55%'}}></div>
									</div>
									<p className='text-sm text-neutral-600'>Medium-hot with aromatic complexity that balances the heat</p>
								</div>

								<div>
									<h4 className='font-semibold text-green-800 mb-3'>Heat Experience:</h4>
									<div className='space-y-3 text-sm text-neutral-700'>
										<div className='flex items-center space-x-3'>
											<span className='w-2 h-2 bg-emerald-600 rounded-full'></span>
											<p><strong>Initial:</strong> Aromatic warmth with citrus brightness</p>
										</div>
										<div className='flex items-center space-x-3'>
											<span className='w-2 h-2 bg-emerald-700 rounded-full'></span>
											<p><strong>Build:</strong> Gentle heat develops with spice complexity</p>
										</div>
										<div className='flex items-center space-x-3'>
											<span className='w-2 h-2 bg-emerald-800 rounded-full'></span>
											<p><strong>Finish:</strong> Long, sophisticated warmth with floral notes</p>
										</div>
									</div>
								</div>
								...
								<div className='bg-white/70 rounded p-3'>
									<p className='text-xs text-neutral-600'>
										<strong>Perfect For:</strong> Food lovers who want heat with sophistication. The aromatics make it more complex than simple chili pastes.
									</p>
								</div>
							</div>
						</div>
						...
						<div className='bg-cream-50 rounded-sm p-8 border border-cream-200'>
							...
							<div className='space-y-6 font-body text-neutral-700'>
								<div>
									<h4 className='font-semibold text-green-800 mb-3'>Signature Dishes:</h4>
									<ul className='space-y-2 text-sm'>
										<li className='flex items-center space-x-2'>
											<span className='w-1.5 h-1.5 bg-slate-700 rounded-full'></span>
											<span><strong>Satay Marinade</strong> - Traditional Indonesian skewers</span>
										</li>
										<li className='flex items-center space-x-2'>
											<span className='w-1.5 h-1.5 bg-slate-700 rounded-full'></span>
											<span><strong>Grilled Seafood</strong> - Enhances natural flavors</span>
										</li>
										<li className='flex items-center space-x-2'>
											<span className='w-1.5 h-1.5 bg-slate-700 rounded-full'></span>
											<span><strong>Beef Rendang</strong> - Authentic spice base</span>
										</li>
										<li className='flex items-center space-x-2'>
											<span className='w-1.5 h-1.5 bg-slate-700 rounded-full'></span>
											<span><strong>Roasted Vegetables</strong> - Elevates simple sides</span>
										</li>
									</ul>
								</div>
								
								<div>
									<h4 className='font-semibold text-green-800 mb-3'>Usage Amounts:</h4>
									<div className='space-y-2 text-sm'>
										<div className='flex justify-between'>
											<span>Marinade base:</span>
											<span className='font-semibold'>1-2 tbsp + oil & lime</span>
										</div>
										<div className='flex justify-between'>
											<span>Stir-fry sauce:</span>
											<span className='font-semibold'>1 tsp per serving</span>
										</div>
										<div className='flex justify-between'>
											<span>Condiment:</span>
											<span className='font-semibold'>1/2 tsp on side</span>
										</div>
									</div>
								</div>
								...
								<div className='bg-white/70 rounded p-3'>
									<p className='text-xs text-neutral-600'>
										<strong>Chef&apos;s Tip:</strong> Mix with coconut milk and lime juice for an instant Balinese curry base that rivals restaurant quality.
									</p>
								</div>
							</div>
						</div>
