...
export default function SambalGorengUKPage() {
	...
	return (
		<div className='min-h-screen bg-gradient-to-br from-cream-50 to-cream-100'>
			...
			<section className='py-16 sm:py-20 lg:py-14 bg-gradient-to-br from-amber-900 via-amber-800 to-orange-900 text-white relative overflow-hidden'>
				<div className='absolute top-0 left-0 w-72 h-72 lg:w-80 lg:h-80 bg-orange-600/20 rounded-full -translate-x-48 -translate-y-48 blur-3xl'></div>
