...
const blogPosts = {
	"spice-islands-history": {
		...
		<div class="bg-gradient-to-r from-burgundy-600 to-burgundy-800 text-white rounded-lg p-8 my-8">
			...
			<div class="flex flex-col sm:flex-row gap-4">
				<a href="https://www.spiceislandindonesia.com/shop" class="bg-white text-burgundy-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-center">
					Shop Authentic Sambal
				</a>
				<a href="https://www.spiceislandindonesia.com/chef" class="border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-burgundy-600 transition-colors text-center">
			...
			<div class="grid md:grid-cols-2 gap-6">
				<div class="bg-white p-4 rounded-lg border border-gold-100">
					<h3 class="font-bold text-burgundy-800 mb-2">
						<a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.spiceislandindonesia.com'}/recipes/sambal-chicken-stir-fry" class="hover:text-burgundy-600">Sambal Chicken Stir-Fry</a>
					</h3>
					<p class="text-gray-700 text-sm">Quick Indonesian-inspired dinner in 25 minutes</p>
				</div>
				<div class="bg-white p-4 rounded-lg border border-gold-100">
					<h3 class="font-bold text-burgundy-800 mb-2">
						<a href="https://www.spiceislandindonesia.com/recipes/sambal-fried-rice" class="hover:text-burgundy-600">Nasi Goreng (Sambal Fried Rice)</a>
					</h3>
					<p class="text-gray-700 text-sm">Indonesia&apos;s national dish made authentic</p>
				</div>
				<div class="bg-white p-4 rounded-lg border border-gold-100">
					<h3 class="font-bold text-burgundy-800 mb-2">
						<a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.spiceislandindonesia.com'}/blog/sambal-british-classics" class="hover:text-burgundy-600">British-Indonesian Fusion</a>
					</h3>
					<p class="text-gray-700 text-sm">Transform British classics with sambal</p>
				</div>
				<div class="bg-white p-4 rounded-lg border border-gold-100">
					<h3 class="font-bold text-burgundy-800 mb-2">
						<a href="https://www.spiceislandindonesia.com/sample-pack-try-first" class="hover:text-burgundy-600">Sample Pack</a>
					</h3>
		...
		<div class="bg-white border border-gold-200 rounded-lg p-6 my-8">
			...
			<div class="space-y-3">
				<p>• <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.spiceislandindonesia.com'}/blog/spice-islands-to-your-kitchen" class="text-burgundy-600 hover:text-burgundy-800 underline">Our Journey from the Spice Islands to Your Kitchen</a></p>
				<p>• <a href="https://www.spiceislandindonesia.com/blog/sambal-vs-hot-sauce" class="text-burgundy-600 hover:text-burgundy-800 underline">Sambal vs Hot Sauce: Understanding the Difference</a></p>
				<p>• <a href="https://www.spiceislandindonesia.com/blog/ultimate-guide-indonesian-sambal" class="text-burgundy-600 hover:text-burgundy-800 underline">The Ultimate Guide to Indonesian Sambal: Beyond Sriracha</a></p>
				<p>• <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.spiceislandindonesia.com'}/sambal-vs-sriracha" class="text-burgundy-600 hover:text-burgundy-800 underline">Sambal vs Sriracha: Understanding the Difference</a></p>
			</div>
		</div>
		`,
	...
	"5-ways-sambal-british-cooking": {
		...
		content: `
		<p>British cuisine is experiencing a spice revolution, and <a href="https://www.spiceislandindonesia.com/sambal-bali-aromatic-spicy" class="text-burgundy-600 hover:text-burgundy-800 underline">Indonesian sambal</a> is leading the charge. This isn't about replacing traditional flavors - it's about enhancing them with the complex heat and depth that only <a href="https://www.spiceislandindonesia.com/shop" class="text-burgundy-600 hover:text-burgundy-800 underline">authentic sambal</a> can provide.</p>
		...
		<div class="bg-white border border-gold-200 rounded-lg p-6 my-6">
			<p class="text-lg mb-4">Elevate your full English with sambal-spiked baked beans that add warmth and complexity to the morning meal. This works particularly well with <a href="https://www.spiceislandindonesia.com/sambal-bali-aromatic-spicy" class="text-burgundy-600 hover:text-burgundy-800 underline">sambal bali's</a> aromatic profile.</p>

			<h3 class="text-xl font-semibold text-burgundy-800 mb-3">The Technique:</h3>
			<div class="bg-cream-50 p-4 rounded-lg mb-4">
				<p>Heat a tin of good-quality baked beans in a saucepan. Stir in 1-2 teaspoons of <a href="https://www.spiceislandindonesia.com/sambal-bali-aromatic-spicy" class="text-burgundy-600 hover:text-burgundy-800 underline">sambal bali</a> (depending on your heat tolerance) and a splash of Worcestershire sauce. The sambal adds depth while the familiar bean sweetness balances the heat perfectly.</p>
			</div>

			<div class="bg-green-50 border-l-4 border-green-400 p-4 rounded-r-lg">
				<p><strong>🍳 Serving suggestion:</strong> Pair with buttery <a href="https://www.spiceislandindonesia.com/recipes/sambal-scrambled-eggs" class="text-burgundy-600 hover:text-burgundy-800 underline">sambal scrambled eggs</a> and crispy bacon. The richness of the eggs helps temper the heat, creating a perfectly balanced breakfast.</p>
			</div>
		</div>
		...
		<div class="bg-white border border-gold-200 rounded-lg p-6 my-6">
			...
			<div class="grid md:grid-cols-2 gap-6 mb-4">
				<div class="bg-red-50 p-4 rounded-lg">
					...
					<p>When browning your mince, add 1 tablespoon of <a href="https://www.spiceislandindonesia.com/sambal-oelek-uk" class="text-burgundy-600 hover:text-burgundy-800 underline">sambal oelek</a> along with your onions and carrots. The sambal will cook down and integrate beautifully with the traditional flavors, adding heat without overwhelming the dish.</p>
				</div>

				<div class="bg-yellow-50 p-4 rounded-lg">
					<h3 class="text-xl font-semibold text-burgundy-800 mb-3">For the Potato Topping:</h3>
					<p>Mix a small amount of <a href="https://www.spiceislandindonesia.com/sambal-bali-aromatic-spicy" class="text-burgundy-600 hover:text-burgundy-800 underline">sambal bali</a> into your mashed potatoes along with butter and milk. This creates subtle heat and aromatic complexity that elevates the entire dish.</p>
				</div>
			</div>

			<div class="bg-orange-50 border-l-4 border-orange-400 p-4 rounded-r-lg">
				<p><strong>👨‍👩‍👧‍👦 Family-friendly tip:</strong> Keep the sambal separate and let family members add their preferred amount. This way, everyone can enjoy the dish at their comfort level. <a href="https://www.spiceislandindonesia.com/sample-pack-try-first" class="text-burgundy-600 hover:text-burgundy-800 underline">Try our sample pack</a> to find your family's perfect heat level!</p>
			</div>
		</div>
		...
		<div class="bg-gradient-to-r from-burgundy-600 to-burgundy-800 text-white rounded-lg p-8 my-8">
			...
			<div class="flex flex-col sm:flex-row gap-4">
				...
				<a href="https://www.spiceislandindonesia.com/sample-pack-try-first" class="border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-burgundy-600 transition-colors text-center">
		...
		<div class="bg-red-50 border border-red-200 rounded-lg p-6 my-6">
			...
			<div class="grid md:grid-cols-3 gap-6">
				...
				<div class="bg-white p-4 rounded-lg border border-red-100">
					...
					<p><a href="https://www.spiceislandindonesia.com/sambal-bali-aromatic-spicy" class="text-burgundy-600 hover:text-burgundy-800 underline">Sambal bali</a> is more approachable for beginners due to its aromatic spices, while <a href="https://www.spiceislandindonesia.com/sambal-oelek-uk" class="text-burgundy-600 hover:text-burgundy-800 underline">sambal oelek</a> provides pure, intense heat.</p>
				</div>
		...
		<div class="bg-gradient-to-r from-gold-50 to-cream-50 border border-gold-200 rounded-lg p-6 my-6">
			<p class="text-lg mb-4">The key to these recipes is using <a href="https://www.spiceislandindonesia.com/authentic-vs-store-bought" class="text-burgundy-600 hover:text-burgundy-800 underline">authentic Indonesian sambal</a>, not mass-produced substitutes. Look for brands that list minimal ingredients - ideally just chilies, salt, and vinegar for <a href="https://www.spiceislandindonesia.com/sambal-oelek-uk" class="text-burgundy-600 hover:text-burgundy-800 underline">sambal oelek</a>, or chilies with traditional spices for <a href="https://www.spiceislandindonesia.com/sambal-bali-aromatic-spicy" class="text-burgundy-600 hover:text-burgundy-800 underline">sambal bali</a>.</p>
			...
			<div class="bg-burgundy-600 text-white p-4 rounded-lg">
				...
				<a href="https://www.spiceislandindonesia.com/shop" class="bg-white text-burgundy-600 px-4 py-2 rounded font-semibold hover:bg-gray-100 transition-colors">
		...
		<div class="bg-gradient-to-r from-burgundy-50 to-gold-50 border border-burgundy-200 rounded-lg p-8 my-8">
			...
			<div class="grid md:grid-cols-2 gap-6">
				<div class="bg-white p-4 rounded-lg border border-gold-100">
					<h3 class="font-bold text-burgundy-800 mb-2">
						<a href="https://www.spiceislandindonesia.com/recipes/sambal-scrambled-eggs" class="hover:text-burgundy-600">Sambal Scrambled Eggs</a>
					</h3>
					<p class="text-gray-700 text-sm">Perfect spicy breakfast ready in 10 minutes</p>
				</div>
				<div class="bg-white p-4 rounded-lg border border-gold-100">
					<h3 class="font-bold text-burgundy-800 mb-2">
						<a href="https://www.spiceislandindonesia.com/recipes/sambal-bbq-marinade" class="hover:text-burgundy-600">Sambal BBQ Marinade</a>
					</h3>
					<p class="text-gray-700 text-sm">Transform your grilling with Indonesian flavors</p>
				</div>
				<div class="bg-white p-4 rounded-lg border border-gold-100">
					<h3 class="font-bold text-burgundy-800 mb-2">
						<a href="https://www.spiceislandindonesia.com/recipes/sambal-fried-rice" class="hover:text-burgundy-600">Sambal Fried Rice</a>
					</h3>
					<p class="text-gray-700 text-sm">Indonesia&apos;s national dish made easy</p>
				</div>
				<div class="bg-white p-4 rounded-lg border border-gold-100">
					<h3 class="font-bold text-burgundy-800 mb-2">
						<a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.spiceislandindonesia.com'}/recipes/sambal-noodle-soup" class="hover:text-burgundy-600">Sambal Noodle Soup</a>
					</h3>
					<p class="text-gray-700 text-sm">Warming comfort food with coconut and spice</p>
				</div>
			</div>
			<div class="text-center mt-6">
				<a href="https://www.spiceislandindonesia.com/recipes" class="bg-burgundy-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-burgundy-700 transition-colors">
					View All Recipes
				</a>
			</div>
		</div>
		...
		<div class="bg-white border border-gold-200 rounded-lg p-6 my-8">
			...
			<div class="space-y-3">
				<p>• <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.spiceislandindonesia.com'}/blog/spice-islands-to-your-kitchen" class="text-burgundy-600 hover:text-burgundy-800 underline">Our Journey from the Spice Islands to Your Kitchen</a></p>
				<p>• <a href="https://www.spiceislandindonesia.com/blog/sambal-vs-hot-sauce" class="text-burgundy-600 hover:text-burgundy-800 underline">Sambal vs Hot Sauce: Understanding the Difference</a></p>
				<p>• <a href="https://www.spiceislandindonesia.com/blog/spice-islands-history" class="text-burgundy-600 hover:text-burgundy-800 underline">The History of the Spice Islands: Where Your Sambal Comes From</a></p>
				<p>• <a href="https://www.spiceislandindonesia.com/blog/ultimate-guide-indonesian-sambal" class="text-burgundy-600 hover:text-burgundy-800 underline">The Ultimate Guide to Indonesian Sambal: Beyond Sriracha</a></p>
			</div>
		</div>
		`,
	...
	"indonesian-spice-levels-british-palates": {
			...
			<div class="bg-white border border-blue-200 rounded-lg p-6">
				...
				<div class="space-y-4">
					...
					<div>
						...
						<ul class="text-sm text-blue-600 mt-1 space-y-1">
							<li>• <a href="https://www.spiceislandindonesia.com/sambal-bali-aromatic-spicy" class="underline">Spice Island Indonesia</a> (authentic direct import)</li>
							<li>• Sous Chef UK</li>
		...
		<div class="bg-burgundy-50 border border-burgundy-200 rounded-lg p-6 my-8">
			...
			<a href="https://www.spiceislandindonesia.com/sambal-bali-aromatic-spicy" class="inline-flex items-center gap-2 bg-burgundy-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-burgundy-700 transition-colors">
	...
	"british-indonesian-fusion-weeknight-recipes": {
		...
		<div class="bg-gradient-to-r from-burgundy-600 to-burgundy-800 text-white rounded-lg p-8 text-center mb-8">
			...
			<div class="flex flex-col sm:flex-row gap-4 justify-center">
				<a href="https://www.spiceislandindonesia.com/sample-pack-try-first" class="inline-flex items-center justify-center gap-2 bg-white text-burgundy-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
					⭐ Try Authentic Sambal First
				</a>
				<a href="https://www.spiceislandindonesia.com/blog/indonesian-cooking-guide-british-kitchens" class="inline-flex items-center justify-center gap-2 border border-white text-white hover:bg-white hover:text-burgundy-600 px-6 py-3 rounded-lg font-semibold transition-colors">
		...
		<div class="bg-green-50 border border-green-200 rounded-lg p-6 my-8">
			...
			<div class="grid md:grid-cols-2 gap-6">
				...
				<ul class="space-y-2 text-green-700">
					<li>• <a href="https://www.spiceislandindonesia.com/sambal-bali-aromatic-spicy" class="underline">Authentic sambal</a> (online delivery)</li>
		...
		<div className='min-h-screen bg-gradient-to-b from-cream-50 to-cream-100'>
			...
			<section className='py-16 bg-gradient-to-br from-burgundy-50 to-gold-50 relative overflow-hidden'>
				...
				<div className='relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
					<Link
						href="https://www.spiceislandindonesia.com/blog"
