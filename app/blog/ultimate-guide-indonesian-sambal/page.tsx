...
const faqData = [
	{
		...
		answer: "Sambal is a thick, rustic paste made with minimal ingredients (chilies, salt, vinegar). Hot sauce is typically liquid, often sweetened, and stabilised.",
	},
	{
		question: "How do I start cooking with sambal?",
		answer: "Start with 1/4 tsp and build gradually. Try eggs, fried rice, noodle soups, marinades and roast veg.",
	},
];
			...
			<article className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
				...
				<header className='text-center mb-10'>
					...
					<p className='text-lg text-neutral-700 max-w-2xl mx-auto'>
						A practical guide to authentic sambal — what it
						is, how it’s made, and how to use it in British
						kitchens.
					</p>
				</header>
				...
				<section className='prose prose-lg max-w-none mb-12'>
					...
					<p>
						Minimal ingredients, stone-ground texture, bright
						chili character, and no unnecessary additives.
						Sambal is a culinary technique as much as it is a
						condiment.
					</p>
					...
					<ul>
						...
						<li>
							Sambal Matah — raw shallot & chili salsa
							(Bali)
						</li>
						<li>
							Sambal Bali — aromatic, with galangal and
							lemongrass
						</li>
					</ul>
					...
					<p>
						Start small and build: scrambled eggs, roast
						potatoes, stir-fries, barbecue marinades, and
						noodle soups. Use it for depth — not just heat.
					</p>
					...
					<div className='bg-gold-50 border border-gold-200 p-6 rounded-lg my-8'>
						...
						<p className='text-neutral-700'>
							Sambal is concentrated. 1/4 tsp can transform
							a dish — add gradually and taste as you go.
						</p>
					</div>
