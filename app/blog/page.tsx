...
export const metadata: Metadata = {
	...
	description: "Discover authentic Indonesian recipes, cooking tips, and stories from the Spice Islands. Learn about traditional sambal making, Indonesian spices, and culinary heritage.",
	keywords: "Indonesian recipes, sambal recipes, Indonesian cooking, Spice Islands, traditional Indonesian cuisine, authentic Indonesian food, Indonesian spices, Maluku recipes",
};
...
const categories = ["All", "Traditional Recipes", "Cooking Tips", "Heritage Stories", "Food Education"];
			...
			<section className="py-16 bg-gradient-to-br from-burgundy-50 to-gold-50 relative overflow-hidden">
				...
				<div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					<h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-burgundy-900 mb-6 font-brand">
						Stories from the
						<span className="text-gold-700 block">Spice Islands</span>
					</h1>
					<p className="text-xl text-neutral-700 max-w-2xl mx-auto leading-relaxed font-body">
						Discover authentic Indonesian recipes, cooking tips, and the rich culinary heritage 
						that inspires our traditional sambal making.
					</p>
				</div>
			</section>
						...
						<Card className="overflow-hidden shadow-luxury border border-gold-200 bg-gradient-to-br from-cream-50 to-cream-100 rounded-3xl">
							<div className="grid lg:grid-cols-2 gap-0">
								...
								<div className="p-8 lg:p-12 flex flex-col justify-center">
									<Badge variant="secondary" className="w-fit mb-4 font-elegant">
									...
									<div className="flex items-center gap-4 text-sm text-neutral-600 mb-6 font-body">
										<div className="flex items-center gap-1">
											...
											{new Date(blogPosts[0].publishDate).toLocaleDateString('en-GB', {
												day: 'numeric',
												month: 'long',
												year: 'numeric'
											})}
						...
						<Card className="max-w-2xl mx-auto shadow-luxury border border-gold-200 bg-gradient-to-br from-burgundy-50 to-gold-50 rounded-3xl overflow-hidden">
							<CardHeader className="pb-6">
								...
								<CardDescription className="text-lg text-neutral-700 font-body">
									Get the latest Indonesian recipes, cooking tips, and stories delivered to your inbox
								</CardDescription>
							</CardHeader>
							<CardContent>
								<Link 
