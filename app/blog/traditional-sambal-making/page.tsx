			...
			<article className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
				...
				<header className='text-center mb-10'>
					...
					<p className='text-lg text-neutral-700 max-w-2xl mx-auto'>
						The principles and techniques behind authentic
						Indonesian sambal — brought to British kitchens.
					</p>
				</header>
				...
				<section className='prose prose-lg max-w-none mb-12'>
					...
					<p>
						For sambal, chili quality matters more than heat
						number. Look for bright aroma and consistent
						flesh. Volcanic soils produce chilies with clean,
						potent flavor.
					</p>

					<h2>Grinding for Texture</h2>
					<p>
						A volcanic stone mortar breaks cells differently
						than blades, creating a coarse, sauce-clinging
						texture. This is why traditional grinding changes
						flavor perception and mouthfeel.
					</p>

					<h2>Balance and Simplicity</h2>
					<p>
						Season lightly. Let the chili speak. Balance salt,
						acidity and aromatics so sambal elevates — not
						masks — the dish.
					</p>

					{/* TODO: Port more sections (family methods, storage, hygiene, step-by-step visuals) */}

					{/* Expanded technique sections */}
					<section className='prose prose-lg max-w-none mb-12'>
						<h2>Preparation Workflow</h2>
						<ol>
							<li>
								Prep chilies: remove stems, keep seeds
								for heat; rinse and pat dry.
							</li>
							<li>
								Salt early: a small pinch helps draw
								moisture and start breaking cells.
							</li>
							<li>
								Grind aromatics first (if using):
								shallot/garlic to a paste, then fold
								chilies in.
							</li>
							<li>
								Adjust acidity: add vinegar a few drops
								at a time — brightness, not sourness.
							</li>
						</ol>
						...
						<ul>
							<li>
								Over‑blending in a food processor —
								yields a thin, saucy texture.
							</li>
							<li>
								Over‑salting early — taste after
								grinding when flavours settle.
							</li>
							<li>
								Adding sugar to mask heat — better to
								temper with fat (eggs, oil) or acid.
							</li>
						</ul>

						<h2>Storage & Safety</h2>
						<p>
							Keep refrigerated in a clean jar. Use clean
							spoons to avoid contamination. For longer
							keeping, a thin layer of neutral oil on top
							helps minimise oxidation.
						</p>
					</section>
				</section>
