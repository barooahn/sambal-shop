...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://spiceislandindonesia.com/blog/spice-islands-to-your-kitchen",
  },
};
...
const faqData = [
  {
    ...
    answer:
      "The Spice Islands refer to the Maluku Islands in Indonesia, historically known for nutmeg, cloves and mace — a region whose volcanic soil and climate shaped Indonesia's spice culture.",
  },
  {
    question: "How does this heritage influence your sambal?",
    answer:
      "We follow traditional techniques learned in family kitchens — careful chili selection, stone-grinding texture, and minimal ingredients — adapted for modern UK food safety standards.",
  },
];
  ...
  return (
    <>
      ...
      <ArticleSchema
        ...
        wordCount={1600}
        keywords={["Spice Islands", "Maluku", "Indonesian sambal", "culinary heritage", "UK kitchens"]}
      />
      <FAQSchema faqs={faqData} pageTitle="Spice Islands to Your Kitchen - FAQ" />
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="text-center mb-10">
          ...
          <p className="text-lg text-neutral-700 max-w-2xl mx-auto">
            From Maluku's volcanic terroir to modern British tables — an authentic story of family tradition,
        ...
        <section className="prose prose-lg max-w-none mb-12">
          <p>
            The Maluku archipelago, historically called the Spice Islands, shaped the world’s taste for centuries. This
            same heritage informs how we craft sambal today—selecting chilies for flavor and heat balance, using
            traditional techniques, and respecting the ingredient’s natural character.
          </p>

          <h2>Volcanic Terroir, Living Tradition</h2>
          <p>
            Chilies grown on volcanic soil develop exceptional complexity. Our approach preserves that complexity
            through minimal processing — a clean ingredient list and careful heat management.
          </p>

          <h2>From Bandung to Britain</h2>
          <p>
            Chef Yossie grew up learning in a family catering kitchen in Bandung. Today, those methods translate to UK
            kitchens: professional technique, authentic flavor, and modern standards.
          </p>

          <div className="bg-gold-50 border border-gold-200 p-6 rounded-lg my-8">
            <p className="font-semibold text-burgundy-900 mb-2">Chef’s Note</p>
            <p className="text-neutral-700">
              True sambal is more than heat — it’s texture, aroma, and a clean, honest chili flavor. Start with small
              amounts and build complexity into your favourite dishes.
            </p>
          </div>
          ...
          <ul>
            <li>
              <Link href="/blog/spice-islands-history" className="text-burgundy-600 hover:text-burgundy-800 underline">
