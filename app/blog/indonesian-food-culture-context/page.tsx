...
const faqData = [
	...
	{
		question:
			"How do Indonesian meal structures differ from British dining?",
		...
		<>
			...
			<ArticleSchema
				...
				keywords={[
					...
					"Indonesian meal etiquette",
					"Indonesian culinary traditions",
					"Indonesian dining customs",
				]}
			/>
			<FAQSchema
				faqs={faqData}
			...
			<article className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
				...
				<header className='text-center mb-12'>
					...
					<p className='text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed'>
						Discover the rich cultural significance behind
						Indonesian cuisine. Learn proper etiquette, meal
						structures, and how to respectfully appreciate the
						deep traditions that make Indonesian food so
						special.
					</p>
				...
				<section className='prose prose-lg max-w-none mb-12'>
						...
						<div className='flex items-start gap-3'>
							...
							<div>
								...
								<p className='text-amber-800 leading-relaxed'>
									"Food in Indonesia is never just
									about eating - it's about family,
									community, respect, and preserving
									our ancestors' wisdom. When you
									cook Indonesian food, you're
									participating in thousands of years
									of cultural tradition.
									Understanding this context will
									deepen your appreciation and make
									your cooking more authentic."
								</p>
							</div>
						</div>
					</div>
					...
					<p className='text-lg leading-relaxed text-gray-700 mb-6'>
						Indonesian cuisine extends far beyond recipes and
						ingredients. It's a living expression of the
						nation's diverse cultural heritage, reflecting the
						values, beliefs, and social structures of over
						17,000 islands and 300 ethnic groups. When we cook
						Indonesian food, we're participating in ancient
						traditions that have been passed down through
						generations.
					</p>

					<p className='text-lg leading-relaxed text-gray-700 mb-8'>
						As you embark on your Indonesian cooking journey
						in your British kitchen, understanding these
						cultural contexts will not only make you a better
						cook but also help you appreciate the deep
						significance behind every dish you prepare.
					</p>
				</section>
							...
							<div>
								...
								<div className='space-y-4 text-gray-700'>
									<p>
										...
										Rice is considered sacred,
										representing life, fertility,
										and prosperity. The rice
										goddess Dewi Sri is honored in
										many Indonesian cultures.
									</p>
									<p>
										<strong>Daily Ritual:</strong>{" "}
										Eating rice three times a day
										isn't just nutrition - it's a
										cultural practice that
										connects people to their
									...
									<p>
										...
										Sharing rice creates unity.
										The phrase "sudah makan nasi?"
										(have you eaten rice?) is how
										Indonesians ask about
										well-being.
									</p>
								</div>
							</div>
							<div>
								...
								<div className='space-y-4 text-gray-700'>
									<p>
										...
										Make rice the foundation of
										Indonesian meals, not a side
										dish.
									</p>
									<p>
										<strong>
										...
										Invest in good jasmine or
										basmati rice - it shows
									...
									<p>
										...
										Take care when preparing rice,
										as it represents the care you
										show for those you're feeding.
									</p>
								</div>
							</div>
						</div>
				...
				<section className='mb-12'>
					<h2 className='text-3xl font-bold text-gray-900 mb-8'>
						Traditional Meal Structure & Etiquette
					</h2>
						...
						<div className='bg-gradient-to-br from-burgundy-50 to-red-50 rounded-lg p-8'>
							...
							<div className='grid md:grid-cols-3 gap-6'>
								...
								<div className='text-center'>
									...
									<p className='text-burgundy-700 text-sm'>
										Sweet, salty, spicy, and fresh
										flavors all present to create
										harmony.
									</p>
								</div>
								<div className='text-center'>
							...
							<div className='grid md:grid-cols-2 gap-8'>
								...
								<div>
									...
									<ul className='space-y-2 text-gray-700 text-sm'>
										...
										<li>
											• Refusing food without
											good reason
										</li>
										<li>
											• Eating before everyone
											is served
										</li>
										<li>
					...
					<div className='space-y-6'>
						<div className='bg-white border border-gray-200 rounded-lg p-6 shadow-sm'>
							...
							<p className='text-gray-700 mb-3'>
								Emphasizes harmony and balance. Meals
								are served with careful attention to
								color, texture, and flavor balance. The
								concept of "sego" (rice) as the
								spiritual center of meals.
							</p>
							<div className='text-sm text-gray-600'>
								<strong>Key dishes:</strong> Gudeg,
								Soto, Gado-gado - all emphasizing
								gentle, balanced flavors
							</div>
						</div>
						...
						<div className='bg-white border border-gray-200 rounded-lg p-6 shadow-sm'>
							...
							<p className='text-gray-700 mb-3'>
								Bold, robust flavors reflecting the
								mountainous terrain. Meals are hearty
								and communal, often featuring rich
								coconut-based curries and intense spice
								blends.
							</p>
							<div className='text-sm text-gray-600'>
								<strong>Key dishes:</strong> Rendang,
								Gulai, Sambal - representing strength
								and bold character
							</div>
						</div>
						...
						<div className='bg-white border border-gray-200 rounded-lg p-6 shadow-sm'>
							<h3 className='text-lg font-semibold text-gray-900 mb-3'>
								Eastern Indonesian Influences
							</h3>
							<p className='text-gray-700 mb-3'>
								Maritime culture emphasizes fresh
								seafood and tropical fruits. Portuguese
								and Dutch influences create unique
								fusion elements while maintaining
								Indonesian soul.
							</p>
							<div className='text-sm text-gray-600'>
								<strong>Key dishes:</strong> Ikan bakar,
								various sambal, tropical fruit desserts
							</div>
						</div>
					</div>
				</section>
					...
					<div className='bg-gradient-to-br from-red-50 to-orange-50 rounded-lg p-8 border border-red-100'>
						<div className='text-center mb-8'>
							...
							<h3 className='text-2xl font-bold text-red-900 mb-4'>
								Cultural Identity in a Bowl
							</h3>
							<p className='text-red-800 max-w-2xl mx-auto'>
								Sambal represents regional identity,
								family heritage, and personal
								expression. Each family guards their
								sambal recipe as a treasured
								inheritance.
							</p>
						</div>
						...
						<div className='grid md:grid-cols-3 gap-6 text-center'>
							<div>
								...
								<p className='text-red-700 text-sm'>
									Each region's sambal reflects local
									ingredients, climate, and cultural
									preferences
								</p>
							</div>
							<div>
							...
							<div>
								...
								<p className='text-red-700 text-sm'>
									Adjusting heat, sweetness, and
									ingredients to reflect individual
									taste and skill
								</p>
							</div>
						</div>
						...
						<div className='space-y-6'>
							<div className='border-l-4 border-blue-400 pl-6'>
								...
								<p className='text-blue-700'>
									...
									significance behind dishes you're
									preparing. This knowledge enriches
									your cooking and shows respect for
									the culture.
								</p>
							</div>
							...
							<div className='border-l-4 border-green-400 pl-6'>
								...
								<p className='text-green-700'>
									...
									when possible. Using quality spices
									and traditional components honors
									the original recipes and their
									creators.
								</p>
							</div>
							...
							<div className='border-l-4 border-purple-400 pl-6'>
								...
								<p className='text-purple-700'>
									When sharing Indonesian dishes with
									British friends, explain their
									cultural significance and credit
									Indonesian culinary traditions.
								</p>
							</div>
							...
							<div className='border-l-4 border-amber-400 pl-6'>
								...
								<p className='text-amber-700'>
									When modifying recipes for British
									tastes, maintain the soul of the
									dish while making necessary
									adjustments for local preferences.
								</p>
							</div>
						</div>
					</div>
				...
				<section className='mb-12'>
					<div className='bg-gradient-to-r from-burgundy-600 to-red-600 text-white rounded-lg p-8'>
						...
						<p className='text-lg mb-6 opacity-90'>
							Understanding Indonesian food culture
							transforms cooking from mere recipe-following
							into a meaningful cultural exchange. Every
							dish you prepare connects you to centuries of
							tradition and thousands of Indonesian
							families who have preserved these flavors.
						</p>
