...
import { User, LogOut, ShoppingBag, Package, CreditCard, Calendar, ArrowRight } from 'lucide-react';
              ...
              <CardContent className="space-y-4">
                ...
                {subscription && (
                  <div className="pt-4 border-t">
                    <p className="text-sm text-gray-600 mb-2">Subscription Status</p>
                    <Badge className={getStatusBadgeColor(subscription.subscription_status)}>
                    ...
                    {subscription.subscription_status === 'active' && subscription.current_period_end && (
                      <p className="text-xs text-gray-500 mt-1">
                        Renews on {formatDate(new Date(subscription.current_period_end * 1000).toISOString())}
                      </p>
                    )}
                  </div>
                )}
                ...
                {orders.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 mb-6">
                      Start shopping for authentic Indonesian sambal to see your orders here.
                    </p>
                    <Link href="/shop">
